    ...
    <div class="flex flex-col h-full divide-y-2 divide-gray-200">
      ...
      <div class="p-6 overflow-scroll h-full">
        <ul class="navbar-nav flex flex-col gap-2" data-fc-type="accordion">
          <!-- Home Page Link -->
          <li class="nav-item">
            <a href="index" class="nav-link"><span class="shrink-0 me-2">
                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>Stockholm-icons / Layout / Layout-4-blocks</title>
                  <desc>Created with Sketch.</desc>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="container">
          <div class="flex">
            <div class="w-full">
              ...
              <p class="mt-1 font-medium mb-4">Welcome Back Mude Capital</p>
            </div>
          </div>
        </div>
      </section>
      <span class="text-10 md:w-10/12 font-bold">Post a Blog</span>
      <form id="frm-edit-blog" enctype="multipart/form-data" class="flex flex-col md:w-10/12" action="/api/blogs/post" method="post">
        <div class="mb-2">
        ...
        <div class="mb-2">
          <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Category
            <span class="text-red-500">*</span></label>
        ...
        <div class="mb-2">
          <label for="exampleInputEmail1" class="block text-sm font-medium mb-1 text-gray-600">Blog Cover
            <span class="text-red-500">*</span></label>
          <input id="blog-cover" type="file" required name="cover" class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" id="exampleInputEmail1" placeholder="Blog Title" />
        </div>
