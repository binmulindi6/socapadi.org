...
<head>
    ...
    <meta property="og:image" content="/public/assets/images/logo/logosquare.png">
    
    <title>easyChik | Pages | Devenir un Partenaire</title>
...
<body>
                    ...
                    <div>
                        ...
                        <nav x-transition :class="!navbarOpen && 'hidden'" id="navbarCollapse" class="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow transition-all lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none">
                            <ul class="block lg:flex">
                                ...
                                <li>
                                    <a href="/blog" class="flex py-2 text-base font-medium hover:text-primary lg:ml-12 lg:inline-flex ">
                                        Blog
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="mb-8 w-full">
                <div class="rounded-lg border border-light bg-[#f7f8fa] py-4 px-4 shadow-card sm:px-6 md:px-8 md:py-5">
                    <ul class="flex items-center">
                        ...
                        <li class="text-base font-semibold text-primary"><span class="font-bold">Devenir Partenaire</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="w-full flex items-center justify-center">
        <div class="container mx-auto w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="p-5 sm:p-5 flex flex-col items-center justify-center">
                <spam class="text-2xl font-semibold text-slate-800 text-center">
                    Bienvenue cher Partenaire,
                </spam>
                <spam class="text-slate-800 text-center">
                    Veuillez fournir ces Informations pour Enregistrer votre Établissement
                </spam>
            </div>
        </div>
    </section>

    <section class=" container mx-auto w-full flex items-center justify-center mb-8">
        <div class="w-full px-4 lg:w-1/2 xl:w-8/12">
            <div class="w-full relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form id="partener-form">
                    <div class="w-full">
                        <div class="mb-6">
                            <label for="nom" class="mb-3 block text-base font-medium text-black">
                                Le Nom Votre Etablissement
                            </label>
                            <input type="text" id="nom-ecole" name="nom" placeholder="Le Nom Votre Etablissement" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                    <div class="mb-6 flex flex-wrap gap-4">
                        <span class="font-semibold mb-">Vous organisz l'Enseignement : </span>
                        <div class="flex flex-wrap gap-4">
                            <div class="flex gap-2">
                                <input type="checkbox" id="maternelle" name="maternelle" class="h-5 w-5" />
                                <label for="maternelle" class="font-semibold flex cursor-pointer select-none items-center">
                                    Maternelle
                                </label>
                            </div>
                            <div class="flex gap-2">
                                <input type="checkbox" id="primaire" name="primaire" class="h-5 w-5" />
                                <label for="primaire" class="font-semibold flex cursor-pointer select-none items-center">
                                    Primaire
                                </label>
                            </div>
                            <div class="flex gap-2">
                                <input type="checkbox" id="secondaire" name="secondaire" class="h-5 w-5" />
                                <label for="secondaire" class="font-semibold flex cursor-pointer select-none items-center">
                                    Secondaire
                                </label>
                            </div>
                            <div class="flex gap-2">
                                <input type="checkbox" id="itm" name="itm" class="h-5 w-5" />
                                <label for="itm" class="font-semibold flex cursor-pointer select-none items-center">
                                    Technique Medical
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="w-full">
                        <div class="mb-6">
                            <label for="mail" class="mb-3 block text-base font-medium text-black">
                                E-Mail
                            </label>
                            <input type="mail" id="mail" name="mail" placeholder="Votre Mail" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                    <div class="w-full">
                        <div class="mb-6">
                            <label for="telephone" class="mb-3 block text-base font-medium text-black">
                                Telephone
                            </label>
                            <input type="text" id="telephone" name="telephone" placeholder="Numero de Telephone" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                    <div class="w-full">
                        <div class="mb-6">
                            <label for="adresse" class="mb-3 block text-base font-medium text-black">
                                Adresse
                            </label>
                            <input type="text" id="adresse" name="adresse" placeholder="L'Adresse de Votre Etablissement" class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        </div>
                    </div>
                    <div>
