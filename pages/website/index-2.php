    ...
    <div class="page-wrapper">
        ...
        <header class="main-header main-header__two">
            ...
            <nav class="main-menu main-menu__two">
                <div class="container">
                    <div class="logo-box">
                        <a href="index" aria-label="logo image"><img src="/assets/images/logo-light-2.png" width="153" alt=""></a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="service-two__card">
                            ...
                            <div class="service-two__card-content">
                                <h3><a href="service-details">Oragnic
                                        Products</a></h3>
                                <p>Lorem ium dolor sit ametad pisicing elit sed simply do ut.</p>
                            </div><!-- /.service-two__card-content -->
                        </div><!-- /.service-two__card -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3">
                        <div class="service-two__card">
                            ...
                            <div class="service-two__card-content">
                                <h3><a href="service-details">Dairy
                                        Products</a></h3>
                                <p>Lorem ium dolor sit ametad pisicing elit sed simply do ut.</p>
                            </div><!-- /.service-two__card-content -->
                        </div><!-- /.service-two__card -->
                        ...
                        <div class="swiper-slide">
                            <div class="projects-one__single">
                                ...
                                <div class="projects-one__content">
                                    ...
                                    <a href="project-details" class="projects-one__button"><i class="agrikon-icon-right-arrow"></i></a><!-- /.projects-one__button -->
                        ...
                        <div class="blog-card">
                            ...
                            <div class="blog-card__content">
                                ...
                                <div class="blog-card__meta">
                                    <a href="blog-details"><i class="far fa-user-circle"></i> by Admin</a>
                                    <a href="blog-details"><i class="far fa-comments"></i> 2 Comments</a>
                                </div><!-- /.blog-card__meta -->
                                <h3><a href="blog-details">Best Way to Do Eco and Agriculture</a></h3>
                                <a href="blog-details" class="thm-btn">Read More</a><!-- /.thm-btn -->
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="blog-card">
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3><a href="blog-details">Leverage agile frameworks to provide</a></h3>
                                <a href="blog-details" class="thm-btn">Read More</a><!-- /.thm-btn -->
                            </div><!-- /.blog-card__content -->
                        </div><!-- /.blog-card -->
                    </div><!-- /.col-md-12 col-lg-4 -->
                    <div class="col-md-12 col-lg-4">
                        <div class="blog-card">
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3><a href="blog-details">Organically grow the holistic world view</a></h3>
                                <a href="blog-details" class="thm-btn">Read More</a><!-- /.thm-btn -->
                            </div><!-- /.blog-card__content -->
                        </div><!-- /.blog-card -->
                    </div><!-- /.col-md-12 col-lg-4 -->
